...
<body>
    ...
    $conn = new mysqli("localhost", "root", "ekdldjxm12!@", "web");
    ...
    ?>
    <table>
        <!--  <?php $title = str_replace(">", "&gt", str_replace("<", "&lt", $row['boardtitle']));
                echo $title; ?> -->
        <tr>
            <th colspan="3">제목 : <?php $title = str_replace(">", "&gt;", str_replace("<", "&lt;", $row['boardtitle']));
                                    echo $title; ?></th>
        </tr>
        <tr>
            <th>작성자 : <?php echo $row['nickname']; ?></th>
            <th>작성일 : <?php echo $row['date']; ?></th>
            <th>조회수 : <?php echo $row['hit']; ?></th>
        </tr>
        <tr></tr>
    </table>
